...
public class LibraryManagementSystemApplication {
    ...
    public CommandLineRunner run(MemberService memberService,
        ...
        return args -> {
            ...
            BookCreationDTO book1Data = new BookCreationDTO("It", "978-0-451-16951-8",2005);
            ...
            BookCreationDTO book2Data = new BookCreationDTO("The Shining", "978-0-307-74365-0",2008);
            BookDTO book2 = authorService.addBookForAuthor(author1.getId(), book2Data);
            System.out.println("Added Book: '" + book2.getTitle() + "' by " + book2.getAuthor().getName() + " (ID: " + book2.getId() + ")" + book1.getPublicationYear());

            // Add Book 3 for Author 2
            BookCreationDTO book3Data = new BookCreationDTO("Harry Potter and the Sorcerer's Stone", "978-0-590-35342-7",2008);
            ...
            try {
                BookCreationDTO duplicateBookData = new BookCreationDTO("Another It", "978-0-451-16951-8",2025);
